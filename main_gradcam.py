...
import cv2
# 数据集类别名
names = ['ShipWrecks', 'AirPlane']  # class names
# yolov5s网络中的三个detect层
target_layers = ['model_17_cv3_act', 'model_20_cv3_act', 'model_23_cv3_act']

# Arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model-path', type=str, default="runs/train/exp_yolov5s_16/weights/best.pt", help='Path to the model')
...
def main(img_path):
    ...
    for target_layer in target_layers:
        ...
        for i, mask in enumerate(masks):
            ...
            output_path = f'{save_path}/{imgae_name[:-4]}_{target_layer[6:8]}_{i}.jpg'
