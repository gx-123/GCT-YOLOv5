...
def run(data,
    ...
    if not training:
        ...
        task = task if task in ('train', 'test', 'test') else 'test'  # path to train/val/test images
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/helmet/weights/best.pt', help='model.pt path(s)')
